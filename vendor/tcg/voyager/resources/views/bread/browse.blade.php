                ...
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            @endforeach
											@if($dataType->slug=='subscribe')
												<a href="" data-email="{{$data['email']}}" class="btn btn-sm btn-dark send"><span>Отправить рассылку </span></a>
												<select class="subscribe">
												@foreach($dataType->subscribeList() as $subscribe)
													<option value="{{ $subscribe->id }}">{{ $subscribe->title }}</option>
												@endforeach
												<select>
											@endif
											@if($dataType->slug=='subscribe-list')
												<a href="" id="{{ $data['id'] }}" class="btn btn-sm btn-dark send"><span>Послать</span></a>
											@endif
                                        </td>
                                    </tr>
                                    @endforeach
							...
							@if($dataType->slug=='subscribe')
								<a href="" class="btn btn-sm btn-dark send" id="all"><span>Отправить рассылку всем</span></a>
							@endif
                        </div>
                        @if ($isServerSide)
                            <div class="pull-left">
