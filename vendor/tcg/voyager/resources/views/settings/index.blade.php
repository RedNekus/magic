    ...
    <div class="page-content settings container-fluid">
        ...
        <div class="panel" style="margin-top:10px;">
            ...
            <div class="panel-body">
				...
				<div class="p-3">
					<button type="submit" class="btn btn-primary pull-right renew-price">Обновить цены</button>
					<button type="submit" class="btn btn-primary pull-right renew-price-list">Обновить прайс-лист</button>
				</div>
            </div>
        </div>
        @endcan
